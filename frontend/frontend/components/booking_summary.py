...
def invoice() -> rx.Component:
    return rx.box(
        ...
        rx.hstack(
            rx.text("Asientos", class_name="invoice-line"),
            rx.spacer(),
            rx.text(State.selected_seats_text, class_name="invoice-line"),
        ),
        rx.hstack(
            rx.text("Boletos", class_name="invoice-line"),
            rx.spacer(),
            money(State.total_boletos),
        ),
        rx.hstack(
            rx.text("Comida", class_name="invoice-line"),
            rx.spacer(),
            money(State.total_comida),
        ),
        rx.hstack(
            rx.text("Cargo servicio", class_name="invoice-line"),
            rx.spacer(),
