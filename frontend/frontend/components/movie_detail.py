        ...
        rx.box(
            ...
            rx.grid(
                ...
                rx.vstack(
                    ...
                    rx.hstack(
                        rx.text(State.current_movie["genero"], class_name="detail-chip"),
                        rx.text(State.current_movie["clasificacion"], class_name="detail-chip"),
                        rx.text(State.current_movie["duracion"], class_name="detail-chip"),
                        spacing="2", wrap="wrap",
                    ),
                    ...
                    rx.hstack(
                        rx.button("Ver trailer", class_name="btn-primary-sm", on_click=State.open_trailer),
                        rx.button("Ocultar trailer", class_name="btn-ghost", on_click=State.close_trailer),
                        spacing="2",
                    ),
                    rx.cond(
                        State.show_trailer,
                        rx.box(
                            rx.el.iframe(src=State.trailer_url, class_name="trailer-frame", allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share", allowfullscreen=True),
                            class_name="trailer-box",
                        ),
                        rx.box(
                            rx.image(src=State.current_movie["image"], class_name="trailer-placeholder-img"),
                            rx.box("Presiona \"Ver trailer\" para cargar el video aquí mismo.", class_name="trailer-placeholder-text"),
